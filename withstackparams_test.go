...
func ExampleWithFuncParams() {
	...
	//     github.com/domonda/go-wraperr/withstackparams_test.go:24
	// github.com/domonda/go-wraperr.funcB([]string{"Hello World!"})
	//     github.com/domonda/go-wraperr/withstackparams_test.go:18
	// github.com/domonda/go-wraperr.funcA(666, "Hello World!")
	//     github.com/domonda/go-wraperr/withstackparams_test.go:12
}
