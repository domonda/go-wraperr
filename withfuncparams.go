...
func newWithFuncParamsSkip(skip int, err error, params ...interface{}) *withStackParams {
	switch w := err.(type) {
	...
	return &withStackParams{
		withStack: withStack{
			err:   err,
			stack: callStack(skip + 1),
		},
		params: params,
	}
}

func WithFuncParamsSkip(skip int, resultVar *error, params ...interface{}) {
	if *resultVar != nil {
		*resultVar = newWithFuncParamsSkip(1+skip, *resultVar, params...)
	}
}

func WithFuncParams(resultVar *error, params ...interface{}) {
	if *resultVar != nil {
		*resultVar = newWithFuncParamsSkip(1, *resultVar, params...)
	}
}

func With0FuncParams(resultVar *error) {
	if *resultVar != nil {
		*resultVar = newWithFuncParamsSkip(1, *resultVar)
	}
}

func With1FuncParams(resultVar *error, p0 interface{}) {
	if *resultVar != nil {
		*resultVar = newWithFuncParamsSkip(1, *resultVar, p0)
	}
}

func With2FuncParams(resultVar *error, p0, p1 interface{}) {
	if *resultVar != nil {
		*resultVar = newWithFuncParamsSkip(1, *resultVar, p0, p1)
	}
}

func With3FuncParams(resultVar *error, p0, p1, p2 interface{}) {
	if *resultVar != nil {
		*resultVar = newWithFuncParamsSkip(1, *resultVar, p0, p1, p2)
	}
}

func With4FuncParams(resultVar *error, p0, p1, p2, p3 interface{}) {
	if *resultVar != nil {
		*resultVar = newWithFuncParamsSkip(1, *resultVar, p0, p1, p2, p3)
	}
}

func With5FuncParams(resultVar *error, p0, p1, p2, p3, p4 interface{}) {
	if *resultVar != nil {
		*resultVar = newWithFuncParamsSkip(1, *resultVar, p0, p1, p2, p3, p4)
	}
}

func With6FuncParams(resultVar *error, p0, p1, p2, p3, p4, p5 interface{}) {
	if *resultVar != nil {
		*resultVar = newWithFuncParamsSkip(1, *resultVar, p0, p1, p2, p3, p4, p5)
	}
}

func With7FuncParams(resultVar *error, p0, p1, p2, p3, p4, p5, p6 interface{}) {
	if *resultVar != nil {
		*resultVar = newWithFuncParamsSkip(1, *resultVar, p0, p1, p2, p3, p4, p5, p6)
	}
}

func With8FuncParams(resultVar *error, p0, p1, p2, p3, p4, p5, p6, p7 interface{}) {
	if *resultVar != nil {
		*resultVar = newWithFuncParamsSkip(1, *resultVar, p0, p1, p2, p3, p4, p5, p6, p7)
	}
}

func With9FuncParams(resultVar *error, p0, p1, p2, p3, p4, p5, p6, p7, p8 interface{}) {
	if *resultVar != nil {
		*resultVar = newWithFuncParamsSkip(1, *resultVar, p0, p1, p2, p3, p4, p5, p6, p7, p8)
	}
}

func With10FuncParams(resultVar *error, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9 interface{}) {
	if *resultVar != nil {
		*resultVar = newWithFuncParamsSkip(1, *resultVar, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9)
	}
}
